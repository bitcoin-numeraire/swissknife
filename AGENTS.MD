...
The dashboard is located under `./dashboard` as a NextJS web app. It will look for a swissknife API running at `http://localhost:3000`. run `yarn install` and `yarn dev` to start the web app locally.
