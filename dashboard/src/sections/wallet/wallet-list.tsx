...
import { deleteWallet, deleteWallets } from 'src/lib/swissknife';
...
import { WalletTableToolbar } from './wallet-table-toolbar';
import { WalletTableFiltersResult } from './wallet-table-filters-result';
...
export function WalletList({ data: wallets, fiatPrices, tableHead }: Props) {
  ...
  const handleDeleteRows = useCallback(async () => {
    ...
    try {
      const { data } = await deleteWallets({ query: { ids: table.selected } });
