...
use crate::{
    ...
    domains::lightning::entities::{LightningAddress, LightningAddressFilter},
};
...
pub trait LightningRepository:
    LightningAddressRepository + TransactionManager + Sync + Send
{
}
...
impl<T> LightningRepository for T where
    T: LightningAddressRepository + TransactionManager + Sync + Send
{
}
